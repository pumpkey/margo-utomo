                        ...
                        <div class="rooms-wrapper">
                            ...
                            <div class="room-card" data-aos="fade-left" data-aos-duration="1400" data-aos-delay="300">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    ...
                                    protected by myths and law. The local people believe that it is a sacred forest. There are several other 
                                    attractions to visit such as Ngagelan Beach (the turtle sanctuary), Pura Giri Salaka (an old 
                                    Hindu temple), Sadengan (the observation tower), and Trianggulasi Beach. 
                                </p>
                        ...
                        <div class="rooms-wrapper">
                            <div class="room-card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    ...
                                    Some local tourist destinations like the waterfall Wono Rejo, which is also known as Tirto Kemanten, 
                                    and the natural reservoir Sumber Salak, which was long ago used as a swimming pool for the plantation 
                                    general managers, are places of interest included in your itinerary. You may also visit the Cocoa Factory 
                                    in Afd. Sumber Baru to see how they process cocoa wet beans into dried cocoa beans. 
                                    It is an important process to determine the quality of cocoa powder or chocolate bars.
                                </p>
                            ...
                            <div class="room-card" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    An enjoyable, interesting and educational excursion to one of the plantations which was 
                                    established in the early 1900s during the colonial era. It provides knowledge about plantation 
                                    crops such as rubber, coffee, cocoa, and clove as well as the processing. An excellent trip to 
                                    find out the long process of those commodities before ending up as a tire on your car or a nice 
                                    hot cup of coffee or hot chocolate on your dining table. The processing of rubber is possible 
                                    to watch throughout the year but sometimes will stop on rainy days (especially early morning rain). 
                                    The coffee season is from June to September, and the cocoa season is in May and October. On this 
                                    tour, you will also observe home industries like tin smith on the way or stop at villages with 
                                    different farming crops (chili pepper, melon, peanut, etc.) depending on the season.
                                </p>

                                <p style="text-align: justify; margin-bottom: 15px;">
                                    <b>Please note</b> factories are closed on Sunday and public holidays.
                                </p>
                                ...
                                <h4 style="margin-bottom: 5px;">Conditions</h4>
                                <ul style="padding-left: 20px; margin-bottom: 15px; text-align: center;">
                                    <li>Additional Tour Guide / Leader joining the guest will be charged at Rp. 50.000 nett 
                                        (1 person only with no additional car)
                                    </li>
                                    <li>Each car will be seated with maximum 6 guests</li>
                                </ul>
                    ...
                    <div class="swiper-slide">
                        <div class="rooms-wrapper">
                            <div class="room-card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="100">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    Various crops will be seen here and our experienced tour guides will explain about the plants 
                                    during the tour in our own plantation adjacent to Margo Utomo Eco Resort. Vanilla, coffee, coconut, 
                                    snake-fruit, cinnamon, nutmeg, pepper, rubber tree, cocoa, and many more are the variety of crops which 
                                    you may not have known better before taking this trip. Our dairy farm with around 80 cows is milked by hand 
                                    every morning at 07:00 am and evening at 07:00 pm. Brown-sugar processing from the sap of undeveloped coconut 
                                    flowers (afternoon), and the butterfly’s aviary are adding to the beauty of this tour. It is a worthwhile and 
                                    wonderful tour suggested to be taken to deepen your knowledge of tropical plants and its products. This knowledge 
                                    will be part of your memorable journey to Kalibaru and Margo Utomo Eco Resort as the Plantation Resort.
                                </p>
                                ...
                                <p style="margin-bottom: 15px; text-align: justify;">
                                    Tours can be arranged for students from Kindergarten to Elementary School as our generation should know more about 
                                    the plants which mostly grow around them. The tour can be arranged by their school or teacher, or even by private 
                                    groups. It is learning with fun.
                                </p>
                            ...
                            <div class="room-card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="100">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    The Ijen Crater Tour brings you to the peak of the Ijen stratovolcanoes complex with a magnificent volcanic landscape. 
                                    Observe the hard life of sulphur miners carrying sulphur rocks from deep down in the crater floor. They carry about 80-100 
                                    kg of sulphur rocks up to the crater rim and walk down about 3 km to the foot of the hill. This tour is recommended for 
                                    active and fit participants only, as the journey is quite challenging. All tourists are prohibited from walking down to 
                                    the Crater Lake, which is also known as Hell’s Kitchen!
                                </p>
                                ...
                                <ul style="padding-left: 20px; margin-bottom: 15px; text-align: center;">
                                    ...
                                    <li>Camera charge – mineral water during tour</li>
                                    <li>Refreshment cold towel – first aid / standard medicines on stand by</li>
                                </ul>

                                <h4 style="margin-bottom: 5px;">Conditions</h4>
                                <ul style="padding-left: 20px; margin-bottom: 15px; text-align: center;">
                                    <li>Additional Tour Guide / Leader joining the guest will be charged at Rp. 200.000 nett (1 person only – with no additional car)</li>
                                    <li>Additional charge if drop straight to Ketapang at Rp. 400.000 nett / car</li>
                                    <li>Each car will be seated with a maximum of 4 guests accompanied by 1 guide</li>
                                    <li>This tour can be cancelled at any time due to weather / other force majeure</li>
                                </ul>
                    ...
                    <div class="swiper-slide">
                        <div class="rooms-wrapper">
                            <div class="room-card" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="100">
                                ...
                                <p style="text-align: justify; margin-bottom: 15px;">
                                    Best Experience in Baluran National Park! Bama Beach, Savana Bekol, and Baluran Mountain. Baluran National Park, 
                                    also better known by its nickname "Africa van Java," is a natural conservation area that has original ecosystems. 
                                    It is managed with a zoning system used for research, science, education, cultivation, tourism, and recreation purposes. 
                                    From the vast Savana Bekol field to the underwater beauty of Bama, there are several other destinations you can visit, 
                                    such as Japan Cave, Tears, Old Well, Manting, Pier, Kramat, Kajang, Balanan, Lempuyang, Talpat, Kacip, Booth, Sejileh, 
                                    freshwater bay, stone stack, and Pandean or Bang Temple.
                                </p>
